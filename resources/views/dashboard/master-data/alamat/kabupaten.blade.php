<div id="kabupaten" class="card mb-5">
    <div class="card-header">
        <div class="d-flex justify-content-between align-items-center ">
            <h3 class="mb-0 fw-bold">Data Kabupaten</h3>
            <div>
    ...
    <div class="card-body">
        <table id="dataTableKabupaten" class="display nowrap table table-striped table-bordered" style="width:100%">
            <thead>
                <tr>
                    <th width="5%">No</th>
                    <th width="10%">Kode</th>
