<div class="sidebar">
    ...
    <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
            ...
            <li class="nav-item">
                <a href="{{ route('dashboard') }}" class="nav-link {{ request()->routeIs('dashboard') ? 'bg-info' : '' }}">
            ...
            <li class="nav-item">
                <a class="nav-link {{ request()->routeIs('kunjungan*') ? 'bg-info' : '' }}" href="{{ route('kunjungan.index') }}">
                    <i class="nav-icon fas fa-calendar icon"></i>
                    Pendaftaran
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ request()->routeIs('antrian*') ? 'bg-info' : '' }}" href="{{ route('antrian.index') }}">
                    <i class="nav-icon fas fa-stethoscope icon"></i>
                    Pemeriksaan
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ request()->routeIs('rekam-medis*') ? 'bg-info' : '' }}" href="{{ route('rekam-medis.index') }}">
                    <i class="nav-icon fas fa-clipboard icon"></i>
                    Rekam Medis
                </a>
            </li>

            <li class="nav-item has-treeview {{ request()->is(['pasien', 'obat', 'poli', 'diagnosa', 'tindakan', 'alamat','practitioner','practitioner-group']) ? 'menu-open' : '' }}">
                <a href="#" class="nav-link  {{ request()->is(['pasien', 'obat', 'poli', 'diagnosa', 'tindakan', 'alamat','practitioner','practitioner-group']) ? 'bg-info' : '' }}">
