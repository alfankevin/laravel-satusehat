...
class RekamMedisController extends Controller
{
    ...
    {
        $pendaftaran = Pendaftaran::with(['pasien', 'laborat.kategoriPemeriksaan', 'laborat.practitioner'])->findOrFail($id);

        return view('dashboard.main-menu.rekam-medis.hasil-lab', compact('pendaftaran'));
    }
}
